					 ...
					 <head>
					  ...
					  <body>
			           ...
			           <font face ="Times New Roman">
						  ...
						  <div>
							  <h1 style="  display: flex; justify-content: center;color:purple;">UPDATE WORK STATUS<h1><br>
					      </div>
						 ...
						 <div id="form-main">
                             <div id="form-div">
                                 <form class="form" id="form1" action= "workstatusprocess.php" method="post">
      
                                     <p class="name">
                                         <input name="refid" type="text" class="validate[required,length[0,30]] feedback-input"  value="<?=$refid;?>" placeholder="Track Ref ID" id="name" style="display:none;" />
                                     </p>
		
		                             <p class="name"><h3> STATUS:
