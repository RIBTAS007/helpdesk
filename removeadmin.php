			      ...
			      <!-- drop down for admin -->
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="background-color:#7822a5;">
                         ...
                         <li data-toggle="collapse" data-target=".navbar-collapse.in"><a  href="#" target="_self" ><span class="glyphicon  glyphicon-user"></span><b>RemoveAdmin</b></a></li>
...
<div class="container">
     <div class="btnpad">
	 <h1 style="color:#7822a5;">WELCOME! TO THE REMOVE ADMIN SECTION</h1>
	</div>


    <!-- data-toggle lets you display modal without any JavaScript -->
	<div class="btnpad">
    <button type="button" class="loginbutton" data-toggle="modal" data-target="#popUpWindow"><h1>PLEASE CLICK HERE TO REMOVE ADMIN</h1></button>
     </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="removeadminprocess.php" method="POST">
...
else
{
	header('Location: adminlogin.php');
		...
		{
			echo"<script type='text/javascript'>alert('admin removed unsuccesful due to wrong values insertion');</script>";
			$_SESSION['error1']="";
		}
		if(isset($_SESSION['error2'])&&!empty($_SESSION['error2']))
		{
			echo"<script type='text/javascript'>alert('You cant remove the admin. MIND IT!');</script>";
			$_SESSION['error2']="";
		}
?>