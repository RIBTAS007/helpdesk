	 ...
	 <html>
		 ...
		 <body>
             <font face ="Times New Roman">
                             ...
                             <ul class="nav navbar-nav navbar-right ">
                                 ...
                                 <li class="dropdown" >
                                     ...
                                     <ul class="dropdown-menu" style="background-color:#7822a5;">
                                          ...
                                          <li data-toggle="collapse" data-target=".navbar-collapse.in"><a href="#" target="_self" ><span class="glyphicon glyphicon-list-alt"></span> <b>UpdateComp</b></a></li>
                 ...
                 <!--updation form proceed button-->
                 
				 <div id="form-main">
                      <div id="form-div">
                         <form class="form" id="form1" action= "updatedetailsprocess.php" method="post">
				  ...
				  <?php
                     ...
                     {   
			  	       echo"<script type='text/javascript'>alert('SORRY UNABLE TO CONNECT TO DATABASE');</script>	";
				       $_SESSION['error1']="";
