...
if (loggedin())
{
         ...
         <head>
		  ...
		  <body>
			 ...
			 <font face ="Times New Roman">
                 ...
                 <div id="form-main">
                     <div id="form-div">
                         <form class="form" id="form1" action= "seefeedbackprocess.php" method="post">
      
                             <p class="name">
                                 <input name="refid" type="text" class="validate[required,length[0,30]] feedback-input" placeholder="Track Ref ID" id="name" required/>
                             </p>
  ...
  <?php
		...
		{   	
			echo"<script type='text/javascript'>alert('WRONG VALUES');</script>";
			 $_SESSION['error']="";
		}
		...
		{   	
			echo"<script type='text/javascript'>alert('fill in values');</script>";
			 $_SESSION['error2']="";
		}
